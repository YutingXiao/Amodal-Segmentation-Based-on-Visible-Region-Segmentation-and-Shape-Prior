...
__all__ = ["load_kins_json"]


def load_kins_json(json_file, image_root, dataset_name=None):
    """
    Load a json file with KINS's instances annotation format.
...
if __name__ == "__main__":
    """
    Test the kins json dataset loader.
    ...
    dicts = load_kins_json(sys.argv[1], sys.argv[2], sys.argv[3])
