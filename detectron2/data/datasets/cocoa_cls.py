...
"""
    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        for anno in anno_dict_list:
            ...
            segm = anno.get("segmentation", None) if not dataset_name.endswith("visible") else anno.get("visible_mask",
                                                                                                        None)
...
if __name__ == "__main__":
    """
    Test the coco cls json dataset loader.

    Usage:
        python -m detectron2.data.datasets.cocoa_cls \
            path/to/json path/to/image_root dataset_name

        "dataset_name" can be "cocoa_cls_val", or other
        pre-registered ones
    """
    ...
    dicts = load_cocoa_cls_json(sys.argv[1], sys.argv[2], sys.argv[3])
